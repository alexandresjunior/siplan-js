...
export const buscarIndicadores = async (
  definirIndicadores,
  ...
  try {
    ...
    const { data: dadosUsuario } = await api.get(
      `${URL_USUARIO_POR_ID}/${idUsuarioSelecionado}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
    ...
    const indicadoresNaoExcluidos = indicadoresMapeados.filter(
      (ind) => !ind.indicadorExcluido
    );
...
export const manipularAdicionarIndicador = async (
  definirIndicadores,
  idUsuarioSelecionado,
  URL_USUARIO_POR_ID,
  ...
  try {
    ...
    const indicadoresAtualizados = [
      ...(dadosUsuario.indicadoresLiberados || []),
      {
    ...
    const { data: respostaAtualizacao } = await api.post(
      URL_ATUALIZAR_USUARIO,
      { ...payload },
      {
        headers: {
...
export const manipularExcluirIndicador = async (
  definirIndicadores,
  idUsuarioSelecionado,
  idIndicador,
  URL_USUARIO_POR_ID,
...
export const manipularAlterarPermissao = async (
  definirPermissoes,
  idUsuarioSelecionado,
  URL_USUARIO_POR_ID,
  URL_ATUALIZAR_USUARIO,
  ...
  try {
    ...
    const usuarioAtualizado = {
      ...
      lotacaoAtual: dadosUsuario.lotacaoAtual
        ? dadosUsuario.lotacaoAtual.id.toString()
        : null,
    ...
    const { data: jsonData } = await api.put(
      `${URL_ATUALIZAR_USUARIO}/${idUsuarioSelecionado}`,
      usuarioAtualizado,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const manipularExcluir = async (
  definirUsuarios,
  definirPaginaAtual,
  definirCarregando,
  idUsuario,
